...
class QwenGPTQQuantizer:
    def __init__(self, base_model_path: str, save_path: str, data_path: str):
        self.base_model_path = base_model_path
        self.save_path = save_path
        self.data_path = data_path

    def get_calibration_data(self, test_size: int = 8) -> list[str]:
    ...
    def quantize_and_save(self, bits: int = 3) -> None:
        ...
        try:
            # Qwen2-VL-2B dùng Qwen2VLForConditionalGeneration (không có _5_)
            ...
            print(f"[SUCCESS] Model đã được lưu tại: {self.save_path}")
